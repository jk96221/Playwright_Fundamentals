...
// nested if-else that prints the bug severity level.
/*
...
*/
// Define the frequency and impact
let frequency = "often";
let impact = "major";

// Classify the bug severity level using nested if-else
let severity;
if (frequency === "always") 
    {
  if (impact === "blocker") severity = "P0";
  else if (impact === "major") severity = "P1";
  else if (impact === "minor") severity = "P2";
} 
else if (frequency === "often") 
    {
    if (impact === "blocker") severity = "P1";
    else if (impact === "major") severity = "P2";
    else if (impact === "minor") severity = "P3";
}
else if (frequency === "rarely")
    {
    if (impact === "blocker") severity = "P2";
    else if (impact === "major") severity = "P3";
    else if (impact === "minor") severity = "P4";
}
else
    {
    severity = "Invalid frequency";
}
// Print the bug severity level
