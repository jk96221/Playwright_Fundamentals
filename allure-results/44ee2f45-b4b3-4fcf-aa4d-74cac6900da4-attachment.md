...
- Location: tests\12_SHADOW_DOM\Project#9_Shadow DOM, Calendars.spec.ts:12:9
                ...
                - generic [ref=f2e8]:
                  ...
                  - generic [ref=f2e16]:
                    - link "Sign in to Google" [ref=f2e17] [cursor=pointer]:
                      - /url: https://accounts.google.com/Login?continue=https%3A%2F%2Fdocs.google.com%2Fforms%2Fd%2Fe%2F1FAIpQLSeguyGBfogdUO6IRfxJapNxTJQTaAEWYfcd5984L0T_q-0Syg%2Fviewform%3Ffbzx%3D8819585855760377315
...
> 8  |         await page.goto(URL);
  ...
  10 |     });
  11 | 
  12 |     test('locate shadow elements and fill form', async ({ page }) => {
  13 | 
  14 |         // Shadow Host
  15 |         const shadowHost = page.locator('#userName');
  16 | 
  17 |         // Name Field
  18 |         const nameField = shadowHost.locator(
  ...
  23 | 
  24 |         // Pizza Field
  25 |         const pizzaField = shadowHost.locator(
  ...
  30 | 
  31 |         // Password Field
  32 |         const passwordField = shadowHost.locator(
