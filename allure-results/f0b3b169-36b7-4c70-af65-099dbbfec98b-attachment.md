      ...
      - region "Web table practice workspace" [ref=e230]:
        - generic [ref=e231]:
          ...
          - generic "Table tools" [ref=e237]:
            - searchbox "Search employee table" [active] [ref=e238]
...
> 12 |   await page.locator('input[type="text"]').fill('Meera.Rao');
     |                                            ^ Error: locator.fill: Test timeout of 30000ms exceeded.
  13 | 
  ...
  21 | 
  22 |   // Select checkbox
  23 |   await checkbox.check();
  24 | 
  25 |   // Verify checkbox selected
  26 |   await expect(checkbox).toBeChecked();
  27 | 
  28 |   console.log('Meera.Rao searched and selected successfully');
  29 | 
  30 |   // Keep browser open for 5 seconds
