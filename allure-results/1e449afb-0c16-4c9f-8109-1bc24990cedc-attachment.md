...
- Location: tests\12_SHADOW_DOM\Project#9_Shadow DOM, Calendars.spec.ts:11:9
...
- generic [ref=e1]:
  ...
  - main [ref=e71]:
    - generic [ref=e73]:
      - generic [ref=e76]:
        - iframe [active] [ref=e78]: "<span data-mce-type=\"bookmark\" style=\"display: inline-block; width: 0px; overflow: hidden; line-height: 0;\" class=\"mce_SELRES_start\"> </span>Loading…":
          - generic [ref=f1e4]:
                ...
                - generic [ref=f2e8]:
                  ...
                  - generic [ref=f2e16]:
                    - link "Sign in to Google" [ref=f2e17] [cursor=pointer]:
                      - /url: https://accounts.google.com/Login?continue=https%3A%2F%2Fdocs.google.com%2Fforms%2Fd%2Fe%2F1FAIpQLSeguyGBfogdUO6IRfxJapNxTJQTaAEWYfcd5984L0T_q-0Syg%2Fviewform%3Ffbzx%3D-7874906249412644022
...
```ts
  ...
  9  |     });
  10 | 
  11 |     test('Enter name, pizza name and password', async ({ page }) => {
  12 | 
  13 |         // Enter Name
  14 |         await page
  15 |             .locator("//input[@placeholder='First Enter name']")
> 16 |             .fill('Narasimha');
     |              ^ Error: locator.fill: Test timeout of 30000ms exceeded.
  17 | 
  18 |         // Enter Pizza Name
  19 |         await page
  20 |             .locator("//input[@name='Enter your favorite pizza']")
  21 |             .fill('Cheese Pizza');
  22 | 
  23 |         // Enter Password
  24 |         await page
  ...
  28 |         // Assertion
  29 |         await expect(
  30 |             page.locator("//input[@placeholder='First Enter name']")
  31 |         ).toHaveValue('Narasimha');
  32 | 
