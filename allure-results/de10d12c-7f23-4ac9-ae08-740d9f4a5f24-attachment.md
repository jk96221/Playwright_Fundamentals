...
- Name: 12_SHADOW_DOM\Project#9_Shadow DOM, Calendars.spec.ts >> SelectorsHub Automation
...
Call log:
  - waiting for locator('//input[@placeholder=\'Enter name\']')
                ...
                - generic [ref=f2e8]:
                  ...
                  - generic [ref=f2e16]:
                    - link "Sign in to Google" [ref=f2e17] [cursor=pointer]:
                      - /url: https://accounts.google.com/Login?continue=https%3A%2F%2Fdocs.google.com%2Fforms%2Fd%2Fe%2F1FAIpQLSeguyGBfogdUO6IRfxJapNxTJQTaAEWYfcd5984L0T_q-0Syg%2Fviewform%3Ffbzx%3D-4861652280685256559
...
```ts
  ...
  2  | 
  3  | test('SelectorsHub Automation', async ({ page }) => {
  4  | 
  5  |     // Open URL
  6  |     await page.goto('https://selectorshub.com/xpath-practice-page/');
  7  | 
  8  |     // Wait for page load
  9  |     await page.waitForLoadState('networkidle');
  10 | 
  11 |     // Name field
  12 |     const name = page.locator("//input[@placeholder='Enter name']");
> 13 |     await name.fill('Narasimha');
     |                ^ Error: locator.fill: Test timeout of 30000ms exceeded.
  14 | 
  15 |     // Pizza field
  16 |     const pizza = page.locator("//input[@placeholder='Enter Pizza Name']");
  17 |     await pizza.fill('Cheese Pizza');
  18 | 
  19 |     // Password field
  20 |     const password = page.locator("//input[@type='password']");
  21 |     await password.fill('Test@123');
  22 | 
  23 |     // Assertion
  24 |     await expect(name).toHaveValue('Narasimha');
  25 | 
