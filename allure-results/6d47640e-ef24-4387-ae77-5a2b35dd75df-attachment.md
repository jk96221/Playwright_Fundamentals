...
- Name: 09_Frames\09_3_frame_within_frame.spec.ts >> Handle Frame within Frame
- Location: tests\09_Frames\09_3_frame_within_frame.spec.ts:3:5
...
```ts
  ...
  2  | 
  3  | test('Handle Frame within Frame', async ({ page }) => {
  4  | 
  5  |     await page.goto('https://selectorshub.com/iframe-scenario');
  6  | 
  7  |     // First iframe
  8  |     const frame1: FrameLocator = page.frameLocator('#pact1');
  9  | 
  10 |     // Second iframe inside first iframe
  11 |     const frame2: FrameLocator = frame1.frameLocator('#pact2');
  12 | 
  13 |     // Third iframe inside second iframe
  14 |     const frame3: FrameLocator = frame2.frameLocator('#pact3');
  15 | 
  16 |     // Fill textboxes
> 17 |     await frame1.locator('#inp_val').fill('Poornima');
     |                                      ^ Error: locator.fill: Error: strict mode violation: locator('#pact1') resolved to 2 elements:
  18 | 
  19 |     await frame2.locator('#jex').fill('Anusha');
  20 | 
  21 |     await frame3.locator('#glaf').fill('Marriage');
  22 | 
  23 |     // Header text from main page
  24 |     const headerText = await page.locator('h3').innerText();
  25 | 
  26 |     console.log(headerText);
  27 | 
